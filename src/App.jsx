...
function App() {
  ...
  return (
    <div className="app-wrapper">
      ...
      {/* HERO SECTION con animación Fade In */}
        ...
        <div className="container">
          {datos.fotoPerfil && (
            <img 
              ...
              alt="Mentor" 
              className="foto-perfil animate-pop"
            />
          )}
      ...
      {/* VENTAJAS con animación Slide Up */}
      ...
      {/* CTA SECTION */}
      <section className="cta-section animate-slide-up" style={{ animationDelay: '0.2s' }}>
        <div className="container">
          ...
          <a href={datos.enlaceWhatsApp} target="_blank" rel="noopener noreferrer">
            <button className="btn-inversion">
      ...
      <footer className="footer-section">
        <p>© {new Date().getFullYear()} IntegratCore. Todos los derechos reservados.</p>
      </footer>
